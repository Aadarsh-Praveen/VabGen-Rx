...
Provides multilingual translation for patient-facing counseling
content generated by the VabGenRx multi-agent clinical system.

This service translates drug counseling, condition counseling,
and orchestrator-generated risk summaries into the patient's
preferred language while preserving clinical accuracy.
...
• Translates only patient-readable fields while preserving internal
  clinical data and evidence metadata.

Translated Sections
-------------------
• Drug counseling points
• Condition counseling advice
• Clinical summaries and prioritized actions
• Compounding risk explanations

This module ensures that VabGenRx can deliver safe and accurate
clinical guidance to patients in over 100 languages without
